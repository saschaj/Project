...
public class AdminServlet extends HttpServlet {
	...
	List<Benutzer> benutzerListe = (List<Benutzer>) session.getAttribute("BenutzerListe");
     ...
     * Datum:	    24.08.2015
     * Version:	    1.0
     *		    1.1 René Kanzenbach 02.09.2015
     *		    -Es wird jetzt geprüft, ob ein Adminname eingegeben wurde.
     *
	...
	//Ausgabe, die auf dem Bildschirm erscheinen soll, wenn der Name
	//des Admins nicht angegeben wurde.
	final String FEHLER_ADMINNAME_LEER = "Bitte geben Sie einen "
		+ "Namen für den Admin an! <br>";
	...
	//Prüfen ob ein Adminname eingegeben wurde
	if (adminName.equals("")) {
	    //Es wurde kein Adminname eingegeben
	    sindEingabenKorrekt = false;
	    fehlerAusgabe += FEHLER_ADMINNAME_LEER;
	}
