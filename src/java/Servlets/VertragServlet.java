		...
		if (ausgabe.equals("")) {
			...
			switch (kategorie) {
				case "Strom":
					...
					neuStromvertrag.setKunde((Kunde) session.getAttribute(
				...
				case "Gas":
					...
					neuGasvertrag.setVertragArt((Vertrag_Art) new DatenZugriffsObjekt().getVertragsArt(
				...
				case "Zeitschriften":
					...
					neuZeitschriftvertrag.setKunde((Kunde) session.getAttribute(
							Konstanten.SESSION_ATTR_BENUTZER));
