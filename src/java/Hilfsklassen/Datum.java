...
/**
 * Ersteller: Julie Kenfack Erstelldatum: 20.08.2015 Version: 1.0 Diese Klasse
 * prüft ob eines eingegebene Datum in der Zukunft liegt.
 */
public class Datum implements Comparable {
    ...
    private void checkDatum(int t, int m, int j) {
        if (j < 1000) {
            throw new IllegalArgumentException("Jahreszahlen unter 1000 sind nicht zugelassen.");
        }
        if (m > 12) {
            throw new IllegalArgumentException("Monat darf nicht größer als 12 sein.");
        }
        if (t > 31) {
            throw new IllegalArgumentException("Tag darf nicht größer als 31 sein.");
        }
        if (t < 29) {
            return;
        }
        ...
        if (t == 29) {
            ...
            if (j % 4 == 0 & (j % 100 != 0 | j % 1000 == 0)) {
                ...
                throw new IllegalArgumentException("29.02." + j + " ist kein reales Datum.");
            }
        }
        if (t == 30) {
            if (m != 2) {
                ...
                throw new IllegalArgumentException("30.02. ist kein reales Datum.");
            }
        }
        if (m == 2 | m == 4 | m == 6 | m == 9 | m == 11) {
            throw new IllegalArgumentException("31." + m + ". ist kein reales Datum.");
        }
    }
